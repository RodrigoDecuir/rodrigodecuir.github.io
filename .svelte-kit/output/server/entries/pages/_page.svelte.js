...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Seo, "Seo").$$render($$result, { title: "Rodrigo Decuir", description: "" }, {}, {})} <div data-svelte-h="svelte-bofcec"><h1 class="montserrat">Rodrigo Decuir</h1> <p class="manrope">I am a computer science student at National Autonomous University of Mexico (UNAM) interested in

...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h1 class="montserrat" data-svelte-h="svelte-8w6ngp">License</h1> <div class="manrope" data-svelte-h="svelte-jizfcg"><p>The license applies to all the <b>documented projects, the projects themselves and their assets</b>. The

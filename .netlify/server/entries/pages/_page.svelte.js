...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Seo, "Seo").$$render($$result, { title: "Rodrigo Decuir", description: "" }, {}, {})} <img src="./assets/images/ani.gif" alt="ojo"> <div class="layout-md" data-svelte-h="svelte-1exrzfr"><h1 class="montserrat lg:font-bold md:font-bold">Rodrigo Decuir</h1> <p class="manrope lg:text-2xl md:text-2xl text-[#424242]">I am a computer science student at National Autonomous University of Mexico (UNAM) interested in
		machine learning, systems and interaction design. <br> <br>
		My hobbies include
		<a class="link" target="_blank" href="https://rodrigodecuir.tumblr.com/">photography</a>
